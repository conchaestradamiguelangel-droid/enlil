...
const GOD_META = {
  ...
  'ninurta': { symbol: '🔥', color: '#ef5350', rgb: '239,83,80',   role: 'Seguridad y Defensa',         model: 'nemotron-3-ultra' },
  'inanna':  { symbol: '🌙', color: '#ce93d8', rgb: '206,147,216', role: 'Comunicación y Ventas',       model: 'mistral-large-2512' },
  'anu':     { symbol: '✨', color: '#26c6da', rgb: '38,198,218',  role: 'Meta y Orquestación',         model: 'gemini-2.5-pro-preview' },
  'marduk':  { symbol: '⚖️', color: '#ff8f00', rgb: '255,143,0',   role: 'Juicio Supremo (solo Full)',  model: 'claude-opus-5' },
  'nabu':    { symbol: '📿', color: '#26a69a', rgb: '38,166,154',  role: 'Razonamiento y Lógica',       model: 'deepseek-v4-pro' },
  'nergal':  { symbol: '⚔️', color: '#d32f2f', rgb: '211,47,47',   role: 'Red Team Adversarial',        model: 'grok-4.5' },
