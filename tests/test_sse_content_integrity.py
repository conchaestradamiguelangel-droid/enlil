...
def _enlil_enabled_and_verified(monkeypatch):
    """synthesize_stream() ahora comparte el mismo kill switch y
    guardarrail economico que consult_god()/synthesize() -- este fichero
    ejerce sintesis real (solo convene_stream esta mockeado) via HTTP,
    necesita el mismo patron de fixture que otros ficheros equivalentes."""
