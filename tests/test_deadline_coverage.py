...
def _enlil_enabled_and_verified_for_synthesis(monkeypatch):
    """Council.synthesize() ahora comparte el mismo kill switch y
    guardarrail economico que consult_god() -- este fichero llama a
    synthesize() directamente contra un cliente mockeado, necesita el
    mismo patron de fixture que ya usan otros ficheros equivalentes
    (ENLIL_ENABLED=true, caps generosos, pricing/accounting FICTICIOS
    solo dentro de cada test)."""
